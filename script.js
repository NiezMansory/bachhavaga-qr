/* ---------- FULL MULTI-LANGUAGE CONTENT + RENDER (CLEAN) ---------- */
...
const translations = {
  ...
  ar: {
    ...
    titles: {
      ...
      vision: "رؤيتنا",
      contact: "تواصل معنا",
      astuce: "نصيحة خبراء Bacchavaga — كيف تختار زيت زيتون استثنائياً",
    },
...
function render(lang){
  ...
  // Astuce section
  if (els.tAstuce) set(els.tAstuce, t.titles.astuce || "Bacchavaga’s Expert Advice – Choose Exceptional Olive Oil");
  const tips = t.astuce || [];
