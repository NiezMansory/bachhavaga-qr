...
const translations = {
  en: {
    ...
    organic: `Tunisia is home to some of the world’s oldest organic olive trees, many of which still grow naturally without chemicals or artificial irrigation. Our groves are part of this unique ecosystem – producing olives rich in flavor and nutrients.`,
    harvest: `Our olives are harvested by hand, using traditional methods passed down through generations. Farmers – including many women of our community – carefully pick each olive to preserve its integrity.`,
    awards: `Tunisian olive oil is celebrated worldwide and has received numerous international awards. Bacchavaga is proud to be part of this story.`,
    sustainability: `We are committed to a sustainable future: protecting our soil, preserving water, and supporting the local farming community.`,
    vision: `Bacchavaga is more than olive oil – it is a story of family, heritage, and pride.`,
    contact: `For inquiries: info@bacchavaga.de`,
    astuce: [
      "Always choose extra virgin: cold-pressed, chemical-free; highest in antioxidants and polyphenols.",
      "Prefer an opaque bottle: light damages flavour and nutrients.",
      "Check the harvest date: fresher is better; consume within 1 year.",
      "Trust certified origin and traceability.",
      "Look for low acidity (<0.8%).",
      "Polyphenols support heart health & slow ageing.",
      "Avoid blends: Bacchavaga is always single-origin."
    ],
  },
  ...
  de: {
    ...
    titles: {
      ...
      contact: "Kontakt",
      astuce: "Bacchavagas Profi-Tipp – So wählen Sie Olivenöl"
    },
    story: `Seit Jahrhunderten bewirtschaftet unsere Familie in Béja Olivenbäume im fruchtbaren Boden Tunesiens. Heute führt Bacchavaga dieses Erbe fort.`,
    organic: `Tunesien ist Heimat einiger der ältesten Bio-Olivenbäume der Welt.`,
    harvest: `Unsere Oliven werden von Hand geerntet – nach alten Methoden.`,
    awards: `Tunesisches Olivenöl wird weltweit gefeiert und hat zahlreiche Preise erhalten.`,
    sustainability: `Wir setzen uns für eine nachhaltige Zukunft ein.`,
    vision: `Bacchavaga ist mehr als Olivenöl – es ist ein Erbe.`,
    contact: `Anfragen: info@bacchavaga.de`,
    astuce: [
      "Immer Extra Nativ wählen: kaltgepresst, ohne Chemie.",
      "Dunkle Flasche bevorzugen: schützt Aroma und Nährstoffe.",
      "Erntedatum prüfen: Öl reift nicht wie Wein.",
      "Zertifizierte Herkunft beachten.",
      "Niedrige Säure (<0,8%) bevorzugen.",
      "An Polyphenole & Gesundheit denken.",
      "Mischungen meiden – Bacchavaga ist Single-Origin."
    ]
  },
  ...
  fr: {
    ...
    story: `Depuis des siècles, notre famille cultive des oliviers à Béja.`,
    organic: `La Tunisie abrite certains des plus anciens oliviers biologiques.`,
    harvest: `Nos olives sont récoltées à la main.`,
    awards: `L’huile tunisienne a remporté de nombreux prix internationaux.`,
    sustainability: `Nous œuvrons pour un avenir durable.`,
    vision: `Bacchavaga est plus qu’une huile – c’est une histoire.`,
    ...
    astuce: [
      ...
      "Observer l’acidité (<0,8%).",
      "Penser polyphénols & santé.",
      "Éviter les mélanges – Bacchavaga est unique."
    ]
  },

 it: {
    label: "🇮🇹 IT", dir: "ltr",
    titles: { hero:"Olio extravergine biologico dalla Tunisia – L’eredità di Vaga", organic:"Ulivi biologici", harvest:"Raccolta tradizionale", awards:"Premi & Riconoscimenti", sustainability:"Sostenibilità", vision:"La nostra visione", contact:"Contatti", astuce:"Consiglio d’Esperto Bacchavaga – Come scegliere un olio d’oliva eccezionale" },
  ...
  es: {
    label: "🇪🇸 ES", dir: "ltr",
    titles: { hero:"Aceite de oliva orgánico premium de Túnez – El legado de Vaga", organic:"Olivos orgánicos", harvest:"Cosecha tradicional", awards:"Premios y Reconocimientos", sustainability:"Sostenibilidad", vision:"Nuestra visión", contact:"Contacto", astuce:"Consejo Experto de Bacchavaga – Cómo elegir un aceite de oliva excepcional" },
  ...
  tr: {
    label: "🇹🇷 TR", dir: "ltr",
    titles: { hero:"Tunus’tan Premium Organik Zeytinyağı – Vaga Mirası", organic:"Organik Zeytin Ağaçları", harvest:"Geleneksel Hasat", awards:"Ödüller ve Tanınırlık", sustainability:"Sürdürülebilirlik", vision:"Vizyonumuz", contact:"İletişim", astuce:"Bacchavaga Uzman Tavsiyesi – Olağanüstü Zeytinyağı Nasıl Seçilir" },
  ...
  nl: {
    label: "🇳🇱 NL", dir: "ltr",
    titles: { hero:"Premium biologische olijfolie uit Tunesië – De erfenis van Vaga", organic:"Biologische olijfbomen", harvest:"Traditionele oogst", awards:"Prijzen & Erkenning", sustainability:"Duurzaamheid", vision:"Onze visie", contact:"Contact", astuce:"Bacchavaga’s Expertadvies – Zo kies je een uitzonderlijke olijfolie" },
  ...
  pl: {
    label: "🇵🇱 PL", dir: "ltr",
    titles: { hero:"Organiczna oliwa premium z Tunezji – Dziedzictwo Vaga", organic:"Organiczne drzewa oliwne", harvest:"Tradycyjne zbiory", awards:"Nagrody i wyróżnienia", sustainability:"Zrównoważony rozwój", vision:"Nasza wizja", contact:"Kontakt", astuce:"Porada Ekspercka Bacchavaga – Jak wybrać wyjątkową oliwę" },
  ...
  ru: {
    label: "🇷🇺 RU", dir: "ltr",
    titles: { hero:"Премиальное органическое оливковое масло из Туниса — Наследие Ваґи", organic:"Органические оливковые деревья", harvest:"Традиционный сбор", awards:"Награды и признание", sustainability:"Устойчивое развитие", vision:"Наша философия", contact:"Контакты", astuce:"Совет экспертов Bacchavaga — как выбрать выдающееся оливковое масло" },
    ...
    sustainability:`Мы привержены устойчивому будущему: защищаем почву, бережем воду и поддерживаем местные фермерские общины. Каждая бутылка Bacchavaga способствует сохранению традиций и передаче оливкового наследия будущим поколениям.`,
  ...
  ar: {
    label: "🇹🇳 AR", dir: "rtl",
    titles: { hero:"زيت زيتون عضوي فاخر من تونس — إرث فاغا", organic:"أشجار زيتون عضوية", harvest:"جني تقليدي", awards:"جوائز وتقدير", sustainability:"الاستدامة", vision:"رؤيتنا", contact:"تواصل معنا", astuce:"نصيحة خبراء Bacchavaga — كيف تختار زيت زيتون استثنائياً" },
    ...
    astuce:[
      "اختَر دائمًا البِكر الممتاز: عَصرٌ بارد بلا كيماويات؛ أعلى محتوى طبيعي من مضادات الأكسدة والبوليفينولات.",
      "فضِّل الزجاجة المعتمة: الضوء يُتلف النكهة والعناصر الغذائية؛ الزجاج الداكن أو العلبة المعدنية يحميان الزيت من المعصرة إلى المطبخ.",
      "تحقّق من تاريخ الحصاد: الزيت لا يعتّق كالنبيذ؛ اختر أحدث حصاد؛ استهلك خلال سنة و3–4 أشهر بعد الفتح.",
      "أصلٌ مُعتمَد وقابل للتتبّع: PDO/PGI أو منشأ واحد مُعلن بوضوح.",
      "انظر إلى الحموضة المنخفضة: أقل من 0.8% (الأفضل نحو 0.3%) — علامة على قطف دقيق وعصرٍ سريع على البارد.",
      "البوليفينولات والصحة: زيت البكر الممتاز الطازج والمحفوظ جيدًا يدعم القلب ويقلّل الإجهاد التأكسدي.",
      "تجنّب الخلطات: المنشأ الواحد يحافظ على طابع البستان — Bacchavaga لا تُخلَط."
    ]
  },
};
};
...
function render(lang){
  ...
  if (sel) sel.title = t.ui?.changeLanguage || "Change language";
  ...
  if (els.tAstuce) els.tAstuce.textContent = t.titles?.astuce || "";
  const tips = t.astuce || [];
